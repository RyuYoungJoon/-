...
float Camera_xPos = 250.0f;
float Camera_yPos = 10.0f;
float Camera_zPos = 100.0f;

float Camera_xAT = 250.0f;
...
GLvoid drawScene()
{
    ...
    view = glm::lookAt(camerapos, cameradirection, cameraup)* CAMERA_ROTATE;
